...
public class ActionsNewActivity extends Activity implements
		FragmentActionsHeadline.Communicator {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		fragment_a = (FragmentActionsHeadline) manager
	...
	public void respond(int position) {
		fragment_b = (FragmentActionsOptions) manager
